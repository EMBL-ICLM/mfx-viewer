function apply_filter_to_data (app)
    ...
    window_all = app.children_apps; %findall(groot(), 'Type', 'figure');
    ...
    for i = 1 : length(window_all)
        ...
        switch window_all{i}.Tag
            ...
            case "figure_histogram"
                ...
                %hist_plot = findobj(fig, 'Type', 'histogram');
                
            case "figure_scatter"
                fig = plot_scatter (app);
                % scatter_plot = findobj(fig, 'Type', 'scatter');
                % scatter_plot.CData = cdata;
